...
class DecryptFrame(customtkinter.CTkFrame):
    ...
    def process_step(self):
        """Processes the decryption recipe one step at a time."""
    ...
    def create_operations_sidebar(self):
        ...
        customtkinter.CTkLabel(scrollable_frame, text="Decoders", font=customtkinter.CTkFont(weight="bold")).grid(row=0,
                                                                                                                  column=0,
                                                                                                                  pady=(
                                                                                                                  5, 2),
                                                                                                                  padx=10,
        ...
        customtkinter.CTkButton(scrollable_frame, text="From Base64", anchor="w",
                                command=lambda: self.add_recipe_step("From Base64")).grid(row=1, column=0, sticky="ew",
                                                                                          padx=10, pady=2)
        ...
        customtkinter.CTkButton(scrollable_frame, text="AES Decrypt", anchor="w",
                                command=lambda: self.add_recipe_step("AES Decrypt")).grid(row=3, column=0, sticky="ew",
                                                                                          padx=10, pady=2)
